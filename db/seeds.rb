...
linkedconnection_one = Linkedconnection.create!(user_id: user_one.id, team_id: team_one.id)
...
linkedconnection_two = Linkedconnection.create!(user_id: user_two.id, team_id: team_two.id)
...
linkedconnection_three = Linkedconnection.create!(user_id: user_three.id, team_id: team_three.id)
